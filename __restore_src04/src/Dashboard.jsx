...
const moveFieldTowardTarget = (fieldKey, currentField, targetField) => {
  ...
  const linkedValues = normalizeLinkedFieldValues({ moisture: nextMoisture });
...
const resetDashboard = async () => {
  ...
  const FieldCard = ({ data, title, fieldKey }) => {
    ...
    const setMoistureDisplayValue = (next) => {
      ...
      // moisture is fully independent — only update moisture, never touch wl or ph
    ...
    const setWaterLevelFromPointer = (clientY) => {
      ...
      // wl is fully independent — never touch moisture refs
